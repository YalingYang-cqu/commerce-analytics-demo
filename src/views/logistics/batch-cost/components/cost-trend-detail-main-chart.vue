...
<script setup lang="ts">
  ...
  import {
    buildTrendMainChartOption,
    type channelSelection as ChannelSelection
  } from '../utils/trend-detail-chart'
  ...
  function buildOptions() {
    ...
    return buildTrendMainChartOption({
      ...
      channelSelection: props.channelSelection,
  ...
  watch(
    () => [props.data, props.metrics.slice(), props.channelSelection, props.selectedMonth] as const,
    refreshChart,
    { deep: true }
  )
