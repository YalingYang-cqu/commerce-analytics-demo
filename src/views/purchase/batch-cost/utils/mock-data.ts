...
const FIXED_MOCK_PRODUCTS: MockProductSeed[] = [
  {
    ...
    baseQuantity: 320,
    latestCosts: [
      { supplierName: '兴源电子', price: 23.89, change: -1.2, daysAgo: 3 },
      { supplierName: '华强北科技', price: 25.6, change: 1.8, daysAgo: 18 }
    ],
  ...
  },
  {
    ...
    baseQuantity: 1200,
    latestCosts: [
      { supplierName: '深圳优品', price: 7.69, change: -0.8, daysAgo: 5 },
      { supplierName: '东莞智造', price: 8.15, change: 2.1, daysAgo: 22 }
    ],
  ...
  },
  {
    ...
    baseQuantity: 580,
    latestCosts: [
      { supplierName: '广州恒达', price: 18.5, change: 0.5, daysAgo: 7 },
      { supplierName: '兴源电子', price: 19.2, change: -1.5, daysAgo: 15 }
    ],
  ...
  },
  {
    ...
    baseUnitCost: 32.0,
    baseQuantity: 210,
    latestCosts: [{ supplierName: '惠州联创', price: 32.0, change: -2.3, daysAgo: 4 }],
  ...
  },
  {
    ...
    baseQuantity: 2500,
    latestCosts: [
      { supplierName: '佛山精工', price: 5.28, change: 0.3, daysAgo: 6 },
      { supplierName: '深圳优品', price: 5.55, change: 1.1, daysAgo: 20 },
      { supplierName: '佛山精工11111', price: 5.28, change: 0.3, daysAgo: 6 },
      { supplierName: '深圳优品1', price: 5.55, change: 1.1, daysAgo: 20 }
    ],
  ...
  },
  {
    ...
    baseQuantity: 150,
    latestCosts: [
      { supplierName: '华强北科技', price: 45.6, change: 3.2, daysAgo: 2 },
      { supplierName: '东莞智造', price: 42.8, change: -1.6, daysAgo: 25 }
    ],
  ...
  },
  {
    ...
    baseUnitCost: 3.15,
    baseQuantity: 4800,
    latestCosts: [{ supplierName: '兴源电子', price: 3.15, change: -0.5, daysAgo: 8 }],
  ...
  },
  {
    ...
    baseQuantity: 95,
    latestCosts: [
      { supplierName: '广州恒达', price: 62.3, change: -4.1, daysAgo: 10 },
      { supplierName: '惠州联创', price: 65.0, change: 2.4, daysAgo: 28 }
    ],
